...
@atexit.register
def copy_stylesheet():
    copy2('docs/resources/custom.css', 'docs/_build/html/_static')
...
latex_documents = [
  (master_doc, 'inspire-schemas.tex', u'inspire-schemas Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'inspire-schemas', u'inspire-schemas Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'inspire-schemas', u'inspire-schemas Documentation',
   author, 'inspire-schemas', 'INSPIREHEP schemas and related tools bundle.',
   'Miscellaneous'),
]
